...
- **ReviewEngine**: The backend orchestration module that executes single-focus and multi-focus code reviews. It sits at a clean seam accepting a `ReviewRequest`, orchestrating diff ingestion, LLM streaming, anti-pattern suppression, and line-range validation behind a single interface.
